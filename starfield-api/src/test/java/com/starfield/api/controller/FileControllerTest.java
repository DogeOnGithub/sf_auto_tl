...
class FileControllerTest {
    ...
    void upload_validFile_returns200WithTaskId() throws Exception {
        ...
        when(fileUploadService.upload(any(), isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(response);
    ...
    void upload_invalidFormat_returns400() throws Exception {
        when(fileUploadService.upload(any(), isNull(), isNull(), isNull(), isNull(), isNull())).thenThrow(new FileUploadService.InvalidEsmFormatException());
