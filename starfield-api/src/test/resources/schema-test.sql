...
CREATE TABLE IF NOT EXISTS translation_confirmation (
...
CREATE TABLE IF NOT EXISTS llm_pool_member (
    id         BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name       VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS llm_pool_member_stat (
    id                  BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    created_at          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT uk_llm_pool_stat_member_date UNIQUE (member_id, stat_date)
);
